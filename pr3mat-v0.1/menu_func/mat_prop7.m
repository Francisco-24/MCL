function varargout = mat_prop7(varargin)
% MAT_PROP7 MATLAB code for mat_prop7.fig
%      MAT_PROP7, by itself, creates a new MAT_PROP7 or raises the existing
%      singleton*.
%
%      H = MAT_PROP7 returns the handle to a new MAT_PROP7 or the handle to
%      the existing singleton*.
%
%      MAT_PROP7('CALLBACK',hObject,eventData,handles,...) calls the local
%      function named CALLBACK in MAT_PROP7.M with the given input arguments.
%
%      MAT_PROP7('Property','Value',...) creates a new MAT_PROP7 or raises the
%      existing singleton*.  Starting from the left, property value pairs are
%      applied to the GUI before mat_prop7_OpeningFcn gets called.  An
%      unrecognized property name or invalid value makes property application
%      stop.  All inputs are passed to mat_prop7_OpeningFcn via varargin.
%
...
% Edit the above text to modify the response to help mat_prop7

% Last Modified by GUIDE v2.5 04-Sep-2018 17:12:57

% Begin initialization code - DO NOT EDIT
gui_Singleton = 1;
gui_State = struct('gui_Name',       mfilename, ...
                   'gui_Singleton',  gui_Singleton, ...
                   'gui_OpeningFcn', @mat_prop7_OpeningFcn, ...
                   'gui_OutputFcn',  @mat_prop7_OutputFcn, ...
                   'gui_LayoutFcn',  [] , ...
                   'gui_Callback',   []);
...
% --- Executes just before mat_prop7 is made visible.
function mat_prop7_OpeningFcn(hObject, eventdata, handles, varargin)
% This function has no output args, see OutputFcn.
% hObject    handle to figure
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)
% varargin   command line arguments to mat_prop7 (see VARARGIN)

% Choose default command line output for mat_prop7
handles.output = hObject;

% Update handles structure
guidata(hObject, handles);

% UIWAIT makes mat_prop7 wait for user response (see UIRESUME)
uiwait(handles.figure1);


% --- Outputs from this function are returned to the command line.
function varargout = mat_prop7_OutputFcn(hObject, eventdata, handles) 
...
ratio_ab = str2double(get(handles.ratio_ab, 'string'));
ratio_ab1 = str2double(get(handles.ratio_ab1, 'string'));
...
function ratio_ab1_Callback(hObject, eventdata, handles)
% hObject    handle to ratio_ab1 (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)

% Hints: get(hObject,'String') returns contents of ratio_ab1 as text
%        str2double(get(hObject,'String')) returns contents of ratio_ab1 as a double


% --- Executes during object creation, after setting all properties.
function ratio_ab1_CreateFcn(hObject, eventdata, handles)
% hObject    handle to ratio_ab1 (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    empty - handles not created until after all CreateFcns called
