function varargout = mat_prop3(varargin)
% MAT_PROP3 MATLAB code for mat_prop3.fig
%      MAT_PROP3, by itself, creates a new MAT_PROP3 or raises the existing
%      singleton*.
%
%      H = MAT_PROP3 returns the handle to a new MAT_PROP3 or the handle to
%      the existing singleton*.
%
%      MAT_PROP3('CALLBACK',hObject,eventData,handles,...) calls the local
%      function named CALLBACK in MAT_PROP3.M with the given input arguments.
%
%      MAT_PROP3('Property','Value',...) creates a new MAT_PROP3 or raises the
%      existing singleton*.  Starting from the left, property value pairs are
%      applied to the GUI before mat_prop3_OpeningFcn gets called.  An
%      unrecognized property name or invalid value makes property application
%      stop.  All inputs are passed to mat_prop3_OpeningFcn via varargin.
%
...
% Edit the above text to modify the response to help mat_prop3

% Last Modified by GUIDE v2.5 06-Sep-2018 16:21:34

% Begin initialization code - DO NOT EDIT
gui_Singleton = 1;
gui_State = struct('gui_Name',       mfilename, ...
                   'gui_Singleton',  gui_Singleton, ...
                   'gui_OpeningFcn', @mat_prop3_OpeningFcn, ...
                   'gui_OutputFcn',  @mat_prop3_OutputFcn, ...
                   'gui_LayoutFcn',  [] , ...
                   'gui_Callback',   []);
...
% --- Executes just before mat_prop3 is made visible.
function mat_prop3_OpeningFcn(hObject, eventdata, handles, varargin)
% This function has no output args, see OutputFcn.
% hObject    handle to figure
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)
% varargin   command line arguments to mat_prop3 (see VARARGIN)

% Choose default command line output for mat_prop3
handles.output = hObject;

% Update handles structure
guidata(hObject, handles);

% UIWAIT makes mat_prop3 wait for user response (see UIRESUME)
uiwait(handles.figure1);


% --- Outputs from this function are returned to the command line.
function varargout = mat_prop3_OutputFcn(hObject, eventdata, handles) 
...
eli_exp = str2num(get(handles.eli_exp, 'string'));
ratio_ab = str2double(get(handles.ratio_ab, 'string'));
ratio_a1b1 = str2double(get(handles.ratio_a1b1, 'string'));
