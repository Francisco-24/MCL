function varargout = mat_prop45(varargin)
% MAT_PROP45 MATLAB code for mat_prop45.fig
%      MAT_PROP45, by itself, creates a new MAT_PROP45 or raises the existing
%      singleton*.
%
%      H = MAT_PROP45 returns the handle to a new MAT_PROP45 or the handle to
%      the existing singleton*.
%
%      MAT_PROP45('CALLBACK',hObject,eventData,handles,...) calls the local
%      function named CALLBACK in MAT_PROP45.M with the given input arguments.
%
%      MAT_PROP45('Property','Value',...) creates a new MAT_PROP45 or raises the
%      existing singleton*.  Starting from the left, property value pairs are
%      applied to the GUI before mat_prop45_OpeningFcn gets called.  An
%      unrecognized property name or invalid value makes property application
%      stop.  All inputs are passed to mat_prop45_OpeningFcn via varargin.
%
...
% Edit the above text to modify the response to help mat_prop45

% Last Modified by GUIDE v2.5 21-Sep-2018 14:31:48

% Begin initialization code - DO NOT EDIT
gui_Singleton = 1;
gui_State = struct('gui_Name',       mfilename, ...
                   'gui_Singleton',  gui_Singleton, ...
                   'gui_OpeningFcn', @mat_prop45_OpeningFcn, ...
                   'gui_OutputFcn',  @mat_prop45_OutputFcn, ...
                   'gui_LayoutFcn',  [] , ...
                   'gui_Callback',   []);
...
% --- Executes just before mat_prop45 is made visible.
function mat_prop45_OpeningFcn(hObject, eventdata, handles, varargin)
% This function has no output args, see OutputFcn.
% hObject    handle to figure
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)
% varargin   command line arguments to mat_prop45 (see VARARGIN)

% Choose default command line output for mat_prop45
handles.output = hObject;

% Update handles structure
guidata(hObject, handles);

% UIWAIT makes mat_prop45 wait for user response (see UIRESUME)
uiwait(handles.figure1);


% --- Outputs from this function are returned to the command line.
function varargout = mat_prop45_OutputFcn(hObject, eventdata, handles) 
...
ratio_tl1 = str2double(get(handles.ratio_tl1, 'string'));
ratio_tl2 = str2double(get(handles.ratio_tl2, 'string'));
ratio_tl3 = str2double(get(handles.ratio_tl3, 'string'));
...
function ratio_tl1_Callback(hObject, eventdata, handles)
% hObject    handle to ratio_tl1 (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)

% Hints: get(hObject,'String') returns contents of ratio_tl1 as text
%        str2double(get(hObject,'String')) returns contents of ratio_tl1 as a double


% --- Executes during object creation, after setting all properties.
function ratio_tl1_CreateFcn(hObject, eventdata, handles)
% hObject    handle to ratio_tl1 (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    empty - handles not created until after all CreateFcns called
...
function ratio_tl2_Callback(hObject, eventdata, handles)
% hObject    handle to ratio_tl2 (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)

% Hints: get(hObject,'String') returns contents of ratio_tl2 as text
%        str2double(get(hObject,'String')) returns contents of ratio_tl2 as a double


% --- Executes during object creation, after setting all properties.
function ratio_tl2_CreateFcn(hObject, eventdata, handles)
% hObject    handle to ratio_tl2 (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    empty - handles not created until after all CreateFcns called
...
function ratio_tl3_Callback(hObject, eventdata, handles)
% hObject    handle to ratio_tl3 (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)

% Hints: get(hObject,'String') returns contents of ratio_tl3 as text
%        str2double(get(hObject,'String')) returns contents of ratio_tl3 as a double


% --- Executes during object creation, after setting all properties.
function ratio_tl3_CreateFcn(hObject, eventdata, handles)
% hObject    handle to ratio_tl3 (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    empty - handles not created until after all CreateFcns called
