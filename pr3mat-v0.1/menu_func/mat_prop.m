function varargout = mat_prop(varargin)
% MAT_PROP MATLAB code for mat_prop.fig
%      MAT_PROP, by itself, creates a new MAT_PROP or raises the existing
%      singleton*.
%
%      H = MAT_PROP returns the handle to a new MAT_PROP or the handle to
%      the existing singleton*.
%
%      MAT_PROP('CALLBACK',hObject,eventData,handles,...) calls the local
%      function named CALLBACK in MAT_PROP.M with the given input arguments.
%
%      MAT_PROP('Property','Value',...) creates a new MAT_PROP or raises the
%      existing singleton*.  Starting from the left, property value pairs are
%      applied to the GUI before mat_prop_OpeningFcn gets called.  An
%      unrecognized property name or invalid value makes property application
%      stop.  All inputs are passed to mat_prop_OpeningFcn via varargin.
%
...
% Edit the above text to modify the response to help mat_prop

% Last Modified by GUIDE v2.5 26-Jul-2018 19:44:31

% Begin initialization code - DO NOT EDIT
gui_Singleton = 1;
gui_State = struct('gui_Name',       mfilename, ...
                   'gui_Singleton',  gui_Singleton, ...
                   'gui_OpeningFcn', @mat_prop_OpeningFcn, ...
                   'gui_OutputFcn',  @mat_prop_OutputFcn, ...
                   'gui_LayoutFcn',  [] , ...
                   'gui_Callback',   []);
...
% --- Executes just before mat_prop is made visible.
function mat_prop_OpeningFcn(hObject, eventdata, handles, varargin)
% This function has no output args, see OutputFcn.
% hObject    handle to figure
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)
% varargin   command line arguments to mat_prop (see VARARGIN)

% Choose default command line output for mat_prop
handles.output = hObject;

% Update handles structure
guidata(hObject, handles);

% UIWAIT makes mat_prop wait for user response (see UIRESUME)
uiwait(handles.figure1);


% --- Outputs from this function are returned to the command line.
function varargout = mat_prop_OutputFcn(hObject, eventdata, handles) 
